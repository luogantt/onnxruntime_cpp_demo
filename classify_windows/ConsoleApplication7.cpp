...
String labels_txt_file = "C://Users//DELL//source//repos//ConsoleApplication7//weights//classification_classes_ILSVRC2012.txt";
...
int main()         // 返回值为整型带参的main函数. 函数体内使用或不使用argc和argv都可
{
	...
	const wchar_t* model_path = L"C://Users//DELL//source//repos//ConsoleApplication7//weights//vgg16.onnx";
	...
	//加载图片
	Mat img = imread("C://Users//DELL//source//repos//ConsoleApplication7//weights//dog.jpg");
